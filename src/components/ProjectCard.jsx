...
const ProjectCard = ({ element }) => {
  ...
  return (
    <motion.div
      ...
      className="p-5 bg-gray-200 dark:bg-gray-800 rounded-lg flex flex-col gap-2 shadow-sm transition-colors ease-in-out duration-500 "
    >
      <div className="relative group">
        <div className="bg-opacity-50  bg-gray-500 absolute w-full h-full rounded-lg flex items-center justify-center gap-4 text-gray-800 scale-y-0 group-hover:scale-y-100 transition-transform duration-500 origin-bottom ease-in-out">
          <a href="">
            <FaExternalLinkAlt className="bg-gray-50 hover:bg-gray-700 hover:text-gray-200 rounded-lg h-12 w-12 p-2 transition-colors duration-300 ease-in-out" />
          </a>
          <a href="">
            <FaGithub className="bg-gray-50 hover:bg-gray-700 hover:text-gray-200 rounded-full h-12 w-12 p-2 transition-colors duration-300 ease-in-out" />
          </a>
        </div>
